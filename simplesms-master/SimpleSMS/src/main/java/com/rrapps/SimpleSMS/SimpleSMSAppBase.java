...
import com.rrapps.SimpleSMS.common.LifecycleHandler;
...
import com.rrapps.SimpleSMS.ui.mms.layout.LayoutManager;
import com.squareup.leakcanary.LeakCanary;
import com.squareup.leakcanary.RefWatcher;

import java.util.Locale;

public class SimpleSMSAppBase extends MultiDexApplication {
    ...
    public void onCreate() {
        ...
        SimpleSMSPreferences.init(this);

        activePendingMessages();
    }

    public static RefWatcher getRefWatcher(Context context) {
        SimpleSMSAppBase application = (SimpleSMSAppBase) context.getApplicationContext();
