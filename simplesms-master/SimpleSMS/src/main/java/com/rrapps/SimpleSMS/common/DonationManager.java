...
import com.rrapps.SimpleSMS.external.iab.IabHelper;
import com.rrapps.SimpleSMS.external.iab.IabResult;
import com.rrapps.SimpleSMS.external.iab.Purchase;
...
public class DonationManager {
    ...
    public static DonationManager getInstance(SimpleSMSActivity context) {
        if (sInstance == null) {
    ...
    private DonationManager(SimpleSMSActivity context) {
        mContext = context;
