package com.rrapps.SimpleSMS.common.formatter;
...
public class NumberToContactFormatter implements Formatter {
    ...
    public String getCurrentCountryIso() {
        if (mCountryIso == null) {
            TelephonyManager tm = (TelephonyManager) SimpleSMSAppBase.getApplication().getSystemService(Context.TELEPHONY_SERVICE);
