...
package com.rrapps.SimpleSMS.mmssms;
...
public class Transaction {
    ...
    public void sendNewMessage(Message message, long threadId) {
        ...
        boolean mmsShortCircuit = SimpleSMSPreferences.getBoolean(SimpleSMSPreference.TEXT_VIA_MMS);
        // if message:
    ...
    private void sendSmsMessage(String text, String[] addresses, long threadId, int delay) {
        ...
        if (saveMessage) {
            ...
            for (int i = 0; i < addresses.length; i++) {
                ...
                if (SimpleSMSPreferences.getBoolean(SimpleSMSPreference.SPLIT_SMS)) {
