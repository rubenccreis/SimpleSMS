package com.rrapps.SimpleSMS.transaction;
...
import com.rrapps.SimpleSMS.common.utils.ImageUtils;
import com.rrapps.SimpleSMS.data.Contact;
import com.rrapps.SimpleSMS.data.ContactHelper;
import com.rrapps.SimpleSMS.data.Message;
import com.rrapps.SimpleSMS.model.ImageModel;
import com.rrapps.SimpleSMS.model.SlideshowModel;
import com.rrapps.SimpleSMS.receiver.RemoteMessagingReceiver;
...
public class NotificationManager {
    ...
    private static void buildSingleMessageNotification(final Context context, ArrayList<MessageItem> messages, long threadId,
        ...
        if (Build.VERSION.SDK_INT < 24) {
            Intent replyIntent = new Intent(context, SimpleSMSReplyActivity.class);
            replyIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            replyIntent.putExtra(SimpleSMSReplyActivity.EXTRA_THREAD_ID, threadId);
            replyIntent.putExtra(SimpleSMSReplyActivity.EXTRA_SHOW_KEYBOARD, true);
    ...
    private static NotificationCompat.Builder copyBuilder(NotificationCompat.Builder builder) {
        NotificationCompat.Builder compatBuilder = new NotificationCompat.Builder(builder.mContext, "SIMPLE_SMS_CH_ID");
    ...
    public static void initQuickCompose(Context context, boolean override, boolean overrideCancel) {
        ...
        if (sPrefs.getBoolean(SettingsFragment.QUICKCOMPOSE, false) || override) {
            Intent composeIntent = new Intent(context, com.rrapps.SimpleSMS.ui.popup.SimpleSMSComposeActivity.class);
