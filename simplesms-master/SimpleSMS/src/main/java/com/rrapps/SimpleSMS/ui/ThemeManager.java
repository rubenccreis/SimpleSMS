package com.rrapps.SimpleSMS.ui;
...
import com.rrapps.SimpleSMS.common.AnalyticsManager;
import com.rrapps.SimpleSMS.common.CIELChEvaluator;
...
import com.rrapps.SimpleSMS.common.utils.Units;
import com.rrapps.SimpleSMS.enums.SimpleSMSPreference;
import com.rrapps.SimpleSMS.receiver.IconColorReceiver;
import com.rrapps.SimpleSMS.theme.IconAdapter;
import com.rrapps.SimpleSMS.ui.base.SimpleSMSActivity;
import com.rrapps.SimpleSMS.ui.dialog.ColorPickerPagerAdapter;
...
public class ThemeManager {
    ...
    public static void setTheme(Theme theme) {
        ...
        if (startColor != endColor) {
            ...
            backgroundAnimation.addUpdateListener(animation -> {
                ...
                LiveViewManager.refreshViews(SimpleSMSPreference.BACKGROUND);
            });
    ...
    public static void setIcon(final SimpleSMSActivity context) {
    ...
    public static void showColorPickerDialog(final SimpleSMSActivity context) {
        showColorPicker(context, v -> setColor(context, getColor()));
    }

    public static void showColorPickerDialogForConversation(final SimpleSMSActivity context, ConversationPrefsHelper prefs) {
        showColorPicker(context, v -> {
            prefs.putString(SimpleSMSPreference.THEME.getKey(), "" + getColor());
            LiveViewManager.refreshViews(SimpleSMSPreference.CONVERSATION_THEME);
        });
    }

    private static void showColorPicker(SimpleSMSActivity context, View.OnClickListener saveListener) {
        ...
        LiveViewManager.registerView(SimpleSMSPreference.THEME, holder.mPreview, key -> {
        ...
        LiveViewManager.registerView(SimpleSMSPreference.BACKGROUND, holder.mHex, key -> {
    ...
    public static void setStatusBarTintEnabled(SimpleSMSActivity activity, boolean enabled) {
    ...
    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public static void setNavigationBarTintEnabled(SimpleSMSActivity activity, boolean enabled) {
        int colorFrom = enabled ? mResources.getColor(R.color.black) : mColor;
        int colorTo = enabled ? mColor : mResources.getColor(R.color.black);
    ...
    public static void setColor(SimpleSMSActivity activity, int color) {
    ...
    public static void setActiveColor(int color) {
        if (mActiveColor != color) {
            mActiveColor = color;
            LiveViewManager.refreshViews(SimpleSMSPreference.THEME);
        }
    }
