...
import com.rrapps.SimpleSMS.common.formatter.FormatterFactory;
import com.rrapps.SimpleSMS.common.google.ItemLoadedCallback;
import com.rrapps.SimpleSMS.common.google.ItemLoadedFuture;
import com.rrapps.SimpleSMS.common.google.PduLoaderManager;
import com.rrapps.SimpleSMS.common.utils.AddressUtils;
    ...
    public MessageItem(Context context, String type, final Cursor cursor,
        ...
        if ("sms".equals(type)) {
            ...
            if (!isOutgoingMessage()) {
                ...
                boolean sent = prefs.getBoolean(SimpleSMSPreference.SENT_TIMESTAMPS.getKey(), false) && !isMe();
            ...
            mItemLoadedFuture = SimpleSMSApp.getApplication().getPduLoaderManager()
