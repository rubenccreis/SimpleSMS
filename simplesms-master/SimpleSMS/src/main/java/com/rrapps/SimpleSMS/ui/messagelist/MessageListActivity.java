...
public class MessageListActivity extends SimpleSMSSwipeBackActivity {
    ...
    public static void launch(SimpleSMSActivity context, long threadId, long rowId, String pattern, boolean showImmediate) {
