...
import com.rrapps.SimpleSMS.common.utils.CursorUtils;
import com.rrapps.SimpleSMS.common.utils.LinkifyUtils;
...
import com.rrapps.SimpleSMS.ui.mms.MmsThumbnailPresenter;
...
public class MessageListAdapter extends RecyclerCursorAdapter<MessageListViewHolder, MessageItem> {
    ...
    public MessageListAdapter(SimpleSMSActivity context) {
        super(context);
    ...
    private void bindNotifInd(final MessageListViewHolder holder, final MessageItem messageItem) {
        ...
        switch (messageItem.getMmsDownloadStatus()) {
            ...
            case DownloadManager.STATE_UNSTARTED:
                ...
                boolean dataSuspended = (SimpleSMSApp.getApplication().getTelephonyManager()
