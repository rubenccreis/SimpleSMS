...
import com.rrapps.SimpleSMS.interfaces.LiveView;
...
public class MessageListViewHolder extends ClickyViewHolder<MessageItem> implements SlideViewInterface {
    ...
    public MessageListViewHolder(SimpleSMSActivity context, View view) {
        super(context, view);
    ...
    protected void setLiveViewCallback(LiveView liveViewCallback) {
        LiveViewManager.registerView(SimpleSMSPreference.THEME, this, liveViewCallback);
    }
