...
import com.rrapps.SimpleSMS.service.CopyUnreadMessageTextService;
import com.rrapps.SimpleSMS.service.DeleteUnreadMessageService;
...
import com.rrapps.SimpleSMS.ui.base.SimpleSMSPopupActivity;
...
public class SimpleSMSReplyActivity extends SimpleSMSPopupActivity implements DialogInterface.OnDismissListener,
        LoaderManager.LoaderCallbacks<Cursor>, ActivityLauncher, ComposeView.OnSendListener {

    @SuppressWarnings("unused")
    private String TAG = "SimpleSMSReplyActivity";
    ...
    private SimpleSMSReplyAdapter mAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new   SimpleSMSReplyAdapter(this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_forward:
                Intent forwardIntent = new Intent(this, SimpleSMSComposeActivity.class);
