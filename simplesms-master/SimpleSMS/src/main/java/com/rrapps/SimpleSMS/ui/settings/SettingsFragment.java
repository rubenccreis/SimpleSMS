...
import com.rrapps.SimpleSMS.common.ListviewHelper;
...
import com.rrapps.SimpleSMS.common.utils.PackageUtils;
import com.rrapps.SimpleSMS.enums.SimpleSMSPreference;
import com.rrapps.SimpleSMS.receiver.NightModeAutoReceiver;
import com.rrapps.SimpleSMS.service.DeleteOldMessagesService;
import com.rrapps.SimpleSMS.transaction.EndlessJabber;
...
import com.rrapps.SimpleSMS.ui.dialog.BlockedNumberDialog;
...
public class SettingsFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = (SimpleSMSActivity) getActivity();
        ...
        if (deleteUnread != null) {
            deleteUnread.setSummary(mContext.getString(R.string.pref_delete_old_messages_unread_summary, SimpleSMSPreferences.getString(SimpleSMSPreference.AUTO_DELETE_UNREAD)));
        }

        EditTextPreference deleteRead = (EditTextPreference) findPreference(DELETE_READ_MESSAGES);
        if (deleteRead != null) {
            deleteRead.setSummary(mContext.getString(R.string.pref_delete_old_messages_read_summary, SimpleSMSPreferences.getString(SimpleSMSPreference.AUTO_DELETE_READ)));
        }
                ...
                if ((Boolean) newValue) {
                    new QKDialog()
                            ...
                            .setPositiveButton(R.string.yes, v -> {
                                SimpleSMSPreferences.setBoolean(SimpleSMSPreference.AUTO_DELETE, true);
